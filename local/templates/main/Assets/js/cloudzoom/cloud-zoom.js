        ...
        this.init = function () {
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                if (opts.tint) {
                    ...
                    $tint = jWin.append(format('<div style="display:none;position:absolute; left:0px; top:0px; width:%0px; height:%1px; background-color:%temp;" />', sImg.outerWidth(), sImg.outerHeight(), opts.tint)).find(':last');
