...
{
	function PrintPropsForm($arSource = array(), $locationTemplate = "temp")
	{
		if (!empty($arSource))
		{
			?>
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						...
						{
							?>
							<input type="hidden" name="<?=$arProperties["FIELD_NAME"]?>" value="" class="input min">
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<div class="bx_block r3x1">
								<input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" class="input email min" />
