...
//
//?>
<!--<form method="post" action="--><?//echo $APPLICATION->GetCurPage()?><!--?mid=--><?php //=urlencode($module_id)?><!--&amp;lang=--><?php //=LANGUAGE_ID?><!--">-->
<?//
//$tabControl->Begin();
...
<!---->
<?//$tabControl->Buttons();?>
<!--	<input --><?//if ($POST_RIGHT<"W") echo "disabled" ?><!-- type="submit" name="Update" value="--><?php //=GetMessage("MAIN_SAVE")?><!--" title="--><?php //=GetMessage("MAIN_OPT_SAVE_TITLE")?><!--" class="adm-btn-save">-->
<!--	<input --><?//if ($POST_RIGHT<"W") echo "disabled" ?><!-- type="submit" name="Apply" value="--><?php //=GetMessage("MAIN_OPT_APPLY")?><!--" title="--><?php //=GetMessage("MAIN_OPT_APPLY_TITLE")?><!--">-->
<!--	--><?//if($_REQUEST["back_url_settings"] <> ''):?>
<!--		<input --><?//if ($POST_RIGHT<"W") echo "disabled" ?><!-- type="button" name="Cancel" value="--><?php //=GetMessage("MAIN_OPT_CANCEL")?><!--" title="--><?php //=GetMessage("MAIN_OPT_CANCEL_TITLE")?><!--" onclick="window.location='--><?//echo htmlspecialcharsbx(CUtil::addslashes($_REQUEST["back_url_settings"]))?>//'">
<!--		<input type="hidden" name="back_url_settings" value="--><?php ////=htmlspecialcharsbx($_REQUEST["back_url_settings"])?><!--<!--">-->-->
<!--	--><?//endif?>
