...
Class shiglov_iblockinterface extends CModule
{
    var $MODULE_ID = "shiglov.iblockinterface";
    ...
    public function __construct()
    {
        ...
        $this->MODULE_ID            = 'shiglov.iblockinterface';
        $this->MODULE_NAME          = 'iblockinterface';
    ...
    {
//        CopyDirFiles($this->GetPath() . "/install/css/phpdevorg.rest", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/css/phpdevorg.parser", true);
...
//        DeleteDirFilesEx("/bitrix/css/phpdevorg.rest");
        return true;
    }
}?>