...
Class phpdevorg_iblocktranslate extends CModule
{
    var $MODULE_ID = "phpdevorg.iblocktranslate";
    ...
    public function __construct()
    {
        ...
        $this->MODULE_ID            = 'phpdevorg.iblocktranslate';
        $this->MODULE_NAME          = 'Переводчик';
    ...
    {
        CopyDirFiles($this->GetPath() . "/install/css/phpdevorg.parser", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/css/phpdevorg.iblocktranslate", true);
        CopyDirFiles($this->GetPath() . "/install/admin/translate_start.php", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/admin/translate_start.php", true);
        return true;
    }
    ...
    function UnInstallFiles()
    {
        ...
        DeleteDirFilesEx("/bitrix/css/phpdevorg.iblocktranslate");
        return true;
    }
}?>